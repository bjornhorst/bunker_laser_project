...
if (sys.platform == "win32"):
    ...
    some_command = "python -m venv venv && venv\Scripts\\activate && py -m pip install flask python-dotenv flask-sqlalchemy flask-login flask-mail pyjwt flask-wtf flask-migrate"
