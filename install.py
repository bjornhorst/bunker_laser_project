...
if (sys.platform == "win32"):
    ...
    some_command = "python -m venv venv && venv\Scripts\\activate && python -m pip install flask python-dotenv flask-sqlalchemy flask-login flask-mail pyjwt flask-wtf flask-migrate email_validator"
