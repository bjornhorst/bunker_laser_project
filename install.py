...
if (sys.platform == "win32"):
    ...
    some_command = "py -m venv venv && venv\Scripts\\activate && py -m pip install flask python-dotenv flask-sqlalchemy flask-login flask-mail pyjwt flask-wtf flask-migrate email_validator"
